...
::
   ...
   DEPLOY_VMLINUZ_UUID="$(openstack image create tinyipa-deploy-ipmi.vmlinuz --public --disk-format=raw --container-format=bare --file ./tinyipa-master.vmlinuz)"
   DEPLOY_INITRD_UUID="$(openstack image create tinyipa-deploy-ipmi.initramfs --public --disk-format=raw --container-format=bare --file ./tinyipa-master.gz)"
...
::
   ...
   port_uuid="$(openstack baremetal port create $NODE_MAC_ADDR --node $machine1_uuid -c uuid -f value)"
